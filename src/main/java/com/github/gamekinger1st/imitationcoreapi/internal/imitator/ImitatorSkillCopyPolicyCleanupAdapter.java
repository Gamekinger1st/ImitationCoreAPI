...
import com.github.gamekinger1st.imitationcoreapi.api.imitator.ImitatorSkillCopyPolicyState;
...
public final class ImitatorSkillCopyPolicyCleanupAdapter implements TransformationApplicationAdapter {
    @Override
    public ResourceLocation id() {
        return ImitatorSkillCopyPolicyState.HANDLER_ID;
    }
